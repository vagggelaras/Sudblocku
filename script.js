	        ...
	        $('.a')
	        	.css("left", function(){
	         		//console.log($(this).index() % 3 * 60 + x)
	          		return $(this).index() % 3 * 60 + x1;
	         	})
	         	.css("top", function(){
	            	return Math.floor($(this).index()/3) * 60 + y1;
	         	});
	        $('.b')
	        	.css("left", function(){
	         		//console.log($(this).index() % 3 * 60 + x)
	          		return $(this).index() % 3 * 60 + x2;
	         	})
	         	.css("top", function(){
	            	return Math.floor($(this).index()/3) * 60 + y2;
	         	});
	        $('.c')
	        	.css("left", function(){
	         		//console.log($(this).index() % 3 * 60 + x)
	          		return $(this).index() % 3 * 60 + x3;
	         	})
	         	.css("top", function(){
	            	return Math.floor($(this).index()/3) * 60 + y3;
	         	});}
		placeBlocks();
	    ...
	    $('.a')
	      ...
	      .drag(function( ev, dd ){
	         ...
	         $( this ).css({
	            top: event.clientY + Math.floor(index/3)*60 - 90,
	            left: event.clientX + index % 3 * 60 - 90
	         });
	      });
	    $('.b')
	      .drag("init",function(){
