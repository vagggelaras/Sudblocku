		...
		function determine(row, col, shape, option){
		    if(shape === 0){
		        ...
		        if(createClass(row-1, col).css("background-color") === 'rgba(0, 0, 0, 0)' && createClass(row, col).css("background-color") === 'rgba(0, 0, 0, 0)' && createClass(row+1, col).css("background-color") === 'rgba(0, 0, 0, 0)'){		        	
		        	...
		        	createClass(row+1, col).css("background-color","black");
		        	setTimeout(functions, 600, shape)
		        	place(row,col,shape)
		...
		function functions(shape){
			checkLine();
			checkCol();
			checkStages9BlocksBackground();}
			// console.log(fits(shape),shape);}
    ...
    if(shape === 0){
        for(let row = 1; row <= 7; row++){
            for(let col = 0; col <= 8; col++){
                if(stage[row-1][col] === 0 && stage[row][col] === 0 && stage[row+1][col] === 0){
                    return "fits";
                }
            }
        }
        ...
        for(let row = 0; row <= 8; row++){
            for(let col = 1; col <= 7; col++){
                if(stage[row][col-1] === 0 && stage[row][col] === 0 && stage[row][col+1] === 0){
                    return 'fits';
                }
            }
        }
        ...
        for(let row = 1; row <= 7; row++){
            for(let col = 1; col <= 7; col++){
                if(stage[row-1][col] === 0 && stage[row][col-1] === 0 && stage[row-1][col] === 0 && stage[row+1][col] === 0 && stage[row][col+1] === 0){
                    return 'fits';
                }
            }
        }
        ...
        for(let row = 1; row <= 7; row++){
            for(let col = 1; col <= 7; col++){
                if(stage[row-1][col+1] === 0 && stage[row][col] === 0 && stage[row+1][col-1] === 0){
                    return 'fits';
                }
            }
        }
        ...
        for(let row = 1; row <= 8; row++){
            for(let col = 1; col <= 8; col++){
                if(stage[row-1][col-1] === 0 && stage[row-1][col] === 0 && stage[row][col] === 0 && stage[row][col-1] === 0){
                    return 'fits';
                }
            }
        }
        ...
        for(let row = 1; row <= 8; row++){
            for(let col = 0; col <= 7; col++){
                if(stage[row-1][col+1] === 0 && stage[row][col] === 0){
                    return 'fits';
                }
            }
        }
        ...
        for(let row = 1; row <= 7; row++){
            for(let col = 1; col <= 7; col++){
                if(stage[row][col-1] === 0 && stage[row+1][col] === 0 && stage[row][col] === 0 && stage[row+1][col+1] === 0 ){
                    return 'fits';
                }
            }
        }
        ...
        for(let row = 1; row <= 7; row++){
            for(let col = 1; col <= 7; col++){
                if(stage[row-1][col-1] === 0 && stage[row][col-1] === 0 && stage[row][col] === 0 && stage[row+1][col] === 0 ){
                    return 'fits';
                }
            }
        }
        ...
        for(let row = 1; row <= 7; row++){
            for(let col = 1; col <= 7; col++){
                if(stage[row-1][col+1] === 0 && stage[row][col] === 0 && stage[row][col+1] === 0 && stage[row+1][col] === 0 ){
                    return 'fits';
                }
            }
        }
        ...
        for(let row = 1; row <= 7; row++){
            for(let col = 1; col <= 7; col++){
                if(stage[row+1][col-1] === 0 && stage[row+1][col] === 0 && stage[row][col] === 0 && stage[row+1][col+1] === 0 ){
                    return 'fits';
                }
            }
        }
        ...
        for(let row = 1; row <= 7; row++){
            for(let col = 1; col <= 8; col++){
                if(stage[row-1][col-1] === 0 && stage[row][col-1] === 0 && stage[row][col] === 0 && stage[row+1][col-1] === 0 ){
                    return 'fits';
                }
            }
        }
        ...
        for(let row = 1; row <= 7; row++){
            for(let col = 1; col <= 8; col++){
                if(stage[row+1][col-1] === 0 && stage[row+1][col] === 0 && stage[row][col] === 0){
                    return 'fits';
                }
            }
        }
        ...
        for(let row = 0; row <= 7; row++){
            for(let col = 0; col <= 8; col++){
                if(stage[row+1][col] === 0 && stage[row][col] === 0){
                    return 'fits';
                }
            }
        }
        ...
        for(let row = 0; row <= 8; row++){
            for(let col = 1; col <= 7; col++){
                if(stage[row][col+1] === 0 && stage[row][col] === 0){
                    return 'fits';
                }
            }
        }
...
//     let c = Math.floor(Math.random() * 23)
